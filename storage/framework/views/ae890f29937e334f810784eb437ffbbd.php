    ...
    <div class="flex-1 flex flex-col h-full">
        ...
        <main class="p-6 flex-1 overflow-y-auto h-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <a href="<?php echo e(route('athletes.index', ['status' => 'Active'])); ?>" class="block bg-white p-5 rounded-xl shadow hover:shadow-lg hover:scale-105 border border-transparent hover:border-green-600 transition-all duration-200 cursor-pointer no-underline group">
                ...
                <a href="<?php echo e(route('athletes.index', ['status' => 'Alumni'])); ?>" class="block bg-white p-5 rounded-xl shadow hover:shadow-lg hover:scale-105 border border-transparent hover:border-blue-600 transition-all duration-200 cursor-pointer no-underline group">
                ...
                <a href="<?php echo e(route('coaches.index', ['status' => 'Active'])); ?>" class="block bg-white p-5 rounded-xl shadow hover:shadow-lg hover:scale-105 border border-transparent hover:border-blue-500 transition-all duration-200 cursor-pointer no-underline group">
                ...
                <a href="<?php echo e(route('athletes.index', ['status' => 'Inactive'])); ?>" class="block bg-white p-5 rounded-xl shadow hover:shadow-lg hover:scale-105 border border-transparent hover:border-orange-600 transition-all duration-200 cursor-pointer no-underline group">
                ...
                <a href="<?php echo e(route('sports')); ?>" class="block bg-white p-5 rounded-xl shadow hover:shadow-lg hover:scale-105 border border-transparent hover:border-indigo-600 transition-all duration-200 cursor-pointer no-underline group">
                    <p class="text-gray-500 group-hover:text-indigo-600 transition-colors">Active Sports</p>
                    <h2 class="text-3xl font-bold text-indigo-600">
                        <?php echo e($activeSports ?? 0); ?>
